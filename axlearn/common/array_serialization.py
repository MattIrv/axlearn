...
async def _async_serialize(
    ...
    *,
    ...
    spec_has_metadata = {
        "0.8.1": lambda: serialization.ts_impl._spec_has_metadata,
    ...
    *,
    ...
    async def cb(index: array.Index, device: jax.Device):
        ...
        estimate_read_memory_footprint = {
            "0.8.1": lambda: serialization.ts_impl.estimate_read_memory_footprint,
    ...
    create_async_array_from_callback = {
        "0.8.1": lambda: serialization.ts_impl._create_async_array_from_callback,
...
class GlobalAsyncCheckpointManager(serialization.GlobalAsyncCheckpointManager):
    ...
    def serialize(
        ...
        *,
        ...
        async_serialize = {
            "0.8.1": lambda: serialization.ts_impl.async_serialize,
